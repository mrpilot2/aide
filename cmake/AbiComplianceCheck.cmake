...
if [ -d .git ] && [ \"${LATEST_RELEASE_TAG}\" != \"`git log --pretty=oneline | cut -d' ' -f1`\" ]; then rm -rf .* 2> /dev/null; fi
    ...
    cd build
    cmake .. -DCMAKE_PROJECT_TOP_LEVEL_INCLUDES=conan_provider.cmake -DBUILD_SHARED_LIBS=ON -DCMAKE_BUILD_TYPE=Debug -Daide_PACKAGING_MAINTAINER_MODE=ON -Daide_ENABLE_ABI_COMPLIANCE_CHECK=ON -DCMAKE_CXX_COMPILER=${CMAKE_CXX_COMPILER}
    cmake --build .
