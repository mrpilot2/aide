...
function(detect_host_profile output_file)
  ...
  detect_arch(MYARCH)
  detect_compiler(
    MYCOMPILER MYCOMPILER_VERSION MYCOMPILER_RUNTIME MYCOMPILER_RUNTIME_TYPE
  )
...
macro(conan_provide_dependency method package_name)
  ...
  if(NOT _conan_install_success)
    ...
    conan_version_check(
      MINIMUM ${CONAN_MINIMUM_VERSION} CURRENT ${CONAN_CURRENT_VERSION}
    )
    message(
      STATUS
    ...
    if(NOT _multiconfig_generator)
      ...
      conan_install(
        ${_host_profile_flags} ${_build_profile_flags} -s build_type=Release
        --build=missing ${generator}
      )
      conan_install(
        ${_host_profile_flags} ${_build_profile_flags} -s build_type=Debug
        --build=missing ${generator}
      )
    endif()
