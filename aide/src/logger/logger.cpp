...
void Logger::doLogTrace(std::string_view message)
{
    m_logger->trace(message);
}

void Logger::doLogDebug(std::string_view message)
{
    m_logger->debug(message);
}

void aide::Logger::doLogInfo(std::string_view message)
{
    m_logger->info(message);
}

void aide::Logger::doLogWarn(std::string_view message)
{
    m_logger->warn(message);
}

void aide::Logger::doLogError(std::string_view message)
{
    m_logger->error(message);
}

void aide::Logger::doLogCritical(std::string_view message)
{
